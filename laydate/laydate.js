...
!function (win) {
    ...
    Dates.viewtb = (function () {
        ...
        table.id = Dates.className = 'laydate_table';
        tr = view = null;
    ...
    Dates.view = function (elem, options) {
        ...
        if (!Dates.box) {
            ...
            div.setAttribute('name', 'laydae-v' + laydate.v);
